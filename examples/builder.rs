...
use smart_home::smart_home::SmartHomeBuilder;
...
fn main() {
    let mut home = SmartHomeBuilder::new("My Smart Home")
        ...
        .add_device(
            "Teapot Outlet",
            Device::new_outlet("Teapot Outlet".to_string(), OutletState::Off, 150 as Watt),
        )
        .add_device(
            "Kitchen thermometer",
            Device::new_thermometer("Kitchen thermometer".to_string(), 20.0 as Celsius),
        )
        .build();
